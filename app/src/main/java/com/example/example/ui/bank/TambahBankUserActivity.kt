...
import com.example.example.ui.bank.bottomSheet.PilihBankGeneralBottomSheet
import com.example.example.util.Prefs
import com.example.example.util.toUrlBank
import org.koin.androidx.viewmodel.ext.android.viewModel

class TambahBankUserActivity : BaseActivity() {
    ...
    private fun create(mData: BankUserRequest) {
        viewModel.create(mData).observe(this) {
            when (it.state) {
                State.SUCCESS -> {
